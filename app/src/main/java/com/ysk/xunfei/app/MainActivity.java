...
import com.ysk.xunfei.Utils.JsonParser;
import com.ysk.xunfei.Utils.TextUnderStandUtils;
import com.ysk.xunfei.adapter.MsgListAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String action = "broadcast.action";
    private static final String PREFER_NAME = "share.dialog";
    private SharedPreferences mSharedPreferences;
    private EditText mMsgInput;
    private Button mMsgSend;
    private Button mVoice;
    private Button mPostUsers;//上传联系人
    ...
    private void init() {
        ...
        mMsgSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String s = mMsgInput.getText().toString();//发送的消息即为s
...
//        }
    ...
    private void dealResult(RecognizerResult recognizerResult) {//讯飞
